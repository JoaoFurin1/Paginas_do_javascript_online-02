...
function calcular(event) {
    ...
    if (imc < 17) {
        ...
        resultado.innerHTML = '</br> Seu resultado foi: ' + imc.toFixed(2) + '</br>Uau! você está no peso ideal!';
    } else if (imc >= 25 && imc < 30) {
        resultado.innerHTML = '</br> Seu resultado foi: ' + imc.toFixed(2) + '</br>Cuidado você está um pouco acima do peso!';
    } else if (imc >= 30 && imc < 35) {
        resultado.innerHTML = '</br> Seu resultado foi: ' + imc.toFixed(2) + '</br>Cuidado você está bem acima do peso!';
